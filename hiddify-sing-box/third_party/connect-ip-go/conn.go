...
// MaxDatagramPayloadSize is 1280 over-claims fit (IP 1280 + overhead 2 > 1280). Product is
// IPv4-only L3 (P2-9); RFC 9484 §7.2 IPv6 underlay abort is N/A until an IPv6 overlay track.
// Do not lie in PTB (P1-7).
