...
type (
	h2ConnectUDPPacketConn = cudph2.PacketConn
	masqueUDPAddr          = cudph2.UDPAddr
)
...
func CapsuleProtocolHeaderValueH2() string {
	return cudph2.CapsuleProtocolHeaderValue()
}
...
func warpMasqueH2AlternateDialHost(host string) string {
	return cudph2.WarpH2AlternateDialHost(host)
}
