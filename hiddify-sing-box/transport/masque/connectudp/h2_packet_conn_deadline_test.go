...
func TestH2PacketConnReadDeadlineElapsed(t *testing.T) {
	pr, _ := io.Pipe()
...
func TestH2PacketConnReadDeadlineInterruptsBlockedBodyRead(t *testing.T) {
	pr, pw := io.Pipe()
	t.Cleanup(func() {
		_ = pw.Close()
		_ = pr.Close()
...
func TestH2PacketConnRejectsOversizedDatagramCapsule(t *testing.T) {
...
func TestH2PacketConnReadsBoundarySizedDatagramCapsule(t *testing.T) {
...
func TestH2PacketConnWriteDeadlineElapsed(t *testing.T) {
	pr, pw := io.Pipe()
	t.Cleanup(func() {
		_ = pr.Close()
		_ = pw.Close()
...
func TestH2PacketConnWriteDeadlineInterruptsBlockedBodyWrite(t *testing.T) {
	pr, pw := io.Pipe()
	t.Cleanup(func() {
		_ = pr.Close()
		_ = pw.Close()
