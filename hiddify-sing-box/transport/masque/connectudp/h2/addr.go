...
// ConnectProto is the RFC 8441 :protocol token for CONNECT-UDP over HTTP/2.
const ConnectProto = "connect-udp"
...
func (m UDPAddr) Network() string { return ConnectProto }
