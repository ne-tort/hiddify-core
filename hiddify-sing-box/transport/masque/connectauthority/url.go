...
// ExpandConnectURL builds the CONNECT request URL (https://target:port/ by default).
func ExpandConnectURL(templateConnect, targetHost string, targetPort uint16) (*url.URL, error) {
