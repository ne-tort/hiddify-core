...
var ArchREFSRCMasqueradeAudit = []ArchREFSRCMasqueradeRow{
	...
	},
	{
		...
		KPINote: "channel decouple ≡ goroutine decouple; server relay not connect-stream download gate root (K-REF-D ~14.7 same relay)",
	...
	},
	{
		...
		KPINote: "Do not port quiche loop; connect-stream-h3 KPI needs client WINDOW + server unchanged relay",
