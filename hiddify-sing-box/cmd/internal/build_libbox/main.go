...
func init() {
	...
	sharedTags = append(sharedTags, "with_gvisor", "with_quic", "with_wireguard", "with_awg", "with_l3router", "with_utls", "with_naive_outbound", "with_clash_api", "with_conntrack", "badlinkname", "tfogo_checklinkname0")
