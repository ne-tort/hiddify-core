...
// Compiled holds precomputed ACL state for MASQUE server HTTP authorization.
...
// Compile builds server authorization state from endpoint options.
func Compile(o option.MasqueEndpointOptions) (*Compiled, error) {
	auth := o.ServerAuth
...
func (a *Compiled) tlsPeerOK(r *http.Request) bool {
...
func checkHTTPAuthHeader(header string, a *Compiled) bool {
...
func (a *Compiled) httpCredentialsOK(r *http.Request) bool {
	if !a.httpConfigured {
		return true
	}
...
func (a *Compiled) AuthorizeRequest(r *http.Request) bool {
	if a == nil {
		return true
	}
