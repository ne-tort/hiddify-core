...
const (
	...
	Core_ChangeClientSettings_FullMethodName  = "/hcore.Core/ChangeClientSettings"
...
type CoreClient interface {
	...
	ChangeClientSettings(ctx context.Context, in *ChangeClientSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error)
...
func (c *coreClient) ChangeClientSettings(ctx context.Context, in *ChangeClientSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CoreInfoResponse)
	err := c.cc.Invoke(ctx, Core_ChangeClientSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) TestEngineEnsure(ctx context.Context, in *TestEngineEnsureRequest, opts ...grpc.CallOption) (*TestEngineEnsureResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TestEngineEnsureResponse)
	err := c.cc.Invoke(ctx, Core_TestEngineEnsure_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) TestEngineStop(ctx context.Context, in *TestEngineStopRequest, opts ...grpc.CallOption) (*TestEngineStopResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TestEngineStopResponse)
	err := c.cc.Invoke(ctx, Core_TestEngineStop_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) TestEnginePing(ctx context.Context, in *TestEnginePingRequest, opts ...grpc.CallOption) (*TestEnginePingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TestEnginePingResponse)
	err := c.cc.Invoke(ctx, Core_TestEnginePing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	ChangeClientSettings(context.Context, *ChangeClientSettingsRequest) (*CoreInfoResponse, error)
	// rpc GenerateConfig (GenerateConfigRequest) returns (GenerateConfigResponse);
...
func (UnimplementedCoreServer) ChangeClientSettings(context.Context, *ChangeClientSettingsRequest) (*CoreInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeClientSettings not implemented")
}
...
func (UnimplementedCoreServer) TestEngineEnsure(context.Context, *TestEngineEnsureRequest) (*TestEngineEnsureResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestEngineEnsure not implemented")
}
func (UnimplementedCoreServer) TestEngineStop(context.Context, *TestEngineStopRequest) (*TestEngineStopResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestEngineStop not implemented")
}
...
func _Core_ChangeClientSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeClientSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).ChangeClientSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_ChangeClientSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).ChangeClientSettings(ctx, req.(*ChangeClientSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Core_TestEngineEnsure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestEngineEnsureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).TestEngineEnsure(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_TestEngineEnsure_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).TestEngineEnsure(ctx, req.(*TestEngineEnsureRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Core_TestEngineStop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestEngineStopRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).TestEngineStop(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_TestEngineStop_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).TestEngineStop(ctx, req.(*TestEngineStopRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Core_TestEnginePing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestEnginePingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).TestEnginePing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_TestEnginePing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).TestEnginePing(ctx, req.(*TestEnginePingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeClientSettings",
			Handler:    _Core_ChangeClientSettings_Handler,
		},
		{
		...
		{
			MethodName: "TestEngineEnsure",
			Handler:    _Core_TestEngineEnsure_Handler,
		},
		{
			MethodName: "TestEngineStop",
			Handler:    _Core_TestEngineStop_Handler,
		},
		{
