...
func CompileRoutingProfile(p *RoutingProfile, geoIPURL, geoSiteURL string) (rulesets []option.RuleSet, rules []option.Rule) {
	...
	appendMatchRules(blockRS, blockDomain, blockCIDR, true, "")
	appendMatchRules(directRS, directDomain, directCIDR, false, OutboundDirectTag)
	appendMatchRules(proxyRS, proxyDomain, proxyCIDR, false, OutboundSelectTag)
