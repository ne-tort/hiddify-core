...
const file_v2_hello_hello_service_proto_rawDesc = "" +
	...
	"\x0eSayHelloStream\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse(\x010\x01BM\n" +
	"\x1fcom.pathology.core.api.v2.helloZ*github.com/ne-tort/pathology-core/v2/hellob\x06proto3"
