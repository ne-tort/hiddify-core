...
$run = 'TestGATEConnectIPUploadSynth|TestGATEConnectIPUploadSynthNative|TestLocalizeConnectIPUploadNativeObs|TestMasqueConnectIPLocalizeBottleneck|TestConnectIPLocalizeForwarderWakeAndWriteQueueMetrics'
