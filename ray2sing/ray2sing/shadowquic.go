...
//
//	shadowquic://user:pass@host:443/?sni=www.example.com&alpn=h3&zero_rtt=0&udp_over_stream=1
func ShadowQUICSingbox(rawURL string) (*T.Outbound, error) {
	...
	opts := &T.ShadowQUICOutboundOptions{
		...
		ZeroRTTHandshake: decoded["zero rtt"] == "1" || decoded["zero rtt"] == "true" || decoded["0rtt"] == "1",
